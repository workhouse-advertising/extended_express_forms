...
use WorkhouseAdvertising\ExtendedExpressForms\Express\Notification\FormBlockSubmissionEmailToSenderNotification;
...
class FormController extends StandardController
{
    ...
    public function getNotifier(NotificationProviderInterface $provider = null)
    {
        ...
        if ($provider) {
            $notifier->getNotificationList()->addNotification(new FormBlockSubmissionEmailToSenderNotification($this->app, $provider));
        }
        return $notifier;
    }
